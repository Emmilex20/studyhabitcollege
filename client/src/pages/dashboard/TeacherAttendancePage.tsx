...
const TeacherAttendancePage: React.FC = () => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-blue-800 mb-6">Record & View Attendance</h2>
      <p className="text-gray-700 mb-4">Record and manage student attendance for your assigned courses and general activities you manage.</p>
      ...
      {attendanceRecords.length === 0 && !loading && !error && (
        <p className="text-center text-gray-500 mt-4">No attendance records found for your courses. Add a new record!</p>
      )}
