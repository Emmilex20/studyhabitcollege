  ...
  useEffect(() => {
    const fetchTeacherCourses = async () => {
      ...
      try {
        ...
        // **ONE LOGICAL CHANGE:** Ensure academicYear and term are not null/undefined strings after fetching and filtering
        const cleanedCourses = teacherAssignedCourses.map((course: Course) => ({
          ...course,
          academicYear: course.academicYear ?? 'Not specified', // Use nullish coalescing for default
          term: course.term ?? 'Not specified',             // Use nullish coalescing for default
        }));
              ...
              >
                ...
                <div className="text-sm text-gray-700 space-y-1 mt-auto">
                  <p className="flex items-center">
                    ...
                    <span className="font-medium text-gray-800">{course.academicYear}</span>
                  </p>
                  <p className="flex items-center">
                    <span className="font-semibold w-28">Term:</span>{' '}
                    <span className="font-medium text-gray-800">{course.term}</span>
                  </p>
                  <p className="flex items-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  <p className="text-gray-800 text-lg mb-1">
                    ...
                    <span className="text-blue-700">{selectedCourse.academicYear}</span>
                  </p>
                  <p className="text-gray-800 text-lg">
                    <strong className="font-semibold">Term:</strong>{' '}
                    <span className="text-blue-700">{selectedCourse.term}</span>
                  </p>
                </div>
                <div>
                  <p className="text-gray-800 text-lg mb-1">
