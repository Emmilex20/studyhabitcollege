...
const TeacherGradebookPage: React.FC = () => {
  ...
  const handleSaveGrade = async () => {
    await fetchGrades(); // Re-fetch all grades after save
  };
  ...
  return (
    <motion.div
      ...
      className="teacher-gradebook-page"
    >
      ...
      {grades.length === 0 && !loading && !error && (
        <p className="text-center text-gray-500 mt-4">No grades found for your courses. Add a new grade!</p>
      )}
