...
const Navbar: React.FC = () => {
  ...
  // NEW: Campus Resources dropdown links
        ...
        <div className="hidden md:flex space-x-6 lg:space-x-8 items-center">
          {navLinks.map((link) => (
            <NavLink
              ...
              className={({ isActive }: NavLinkRenderProps) =>
                `relative text-lg font-medium transition-colors duration-300 hover:text-yellow-400 group ${
          ...
          <div className="relative" ref={newsEventsDropdownRef}>
            <button
              ...
              className={`relative text-lg font-medium transition-colors duration-300 hover:text-yellow-400 group flex items-center ${
            ...
            <AnimatePresence>
              {isNewsEventsDropdownOpen && (
                <motion.div
                  ...
                  animate="visible"
                  exit="exit"
                  className="absolute left-1/2 -translate-x-1/2 mt-4 w-48 bg-blue-800 rounded-lg shadow-xl overflow-hidden py-2"
                >
          ...
          {/* NEW: Campus Resources Dropdown (Desktop) */}
          ...
          {userInfo ? (
            <>
              <Link
                to="/dashboard"
                className="ml-4 px-5 py-2 bg-green-500 text-blue-900 font-semibold rounded-full shadow-md hover:bg-green-600 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
              ...
              <button
                ...
                className="px-5 py-2 bg-red-500 text-white font-semibold rounded-full shadow-md hover:bg-red-600 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
              >
                Logout
              </button>
            </>
            ...
            <Link
              to="/login"
              className="ml-4 px-5 py-2 bg-yellow-500 text-blue-900 font-semibold rounded-full shadow-md hover:bg-yellow-600 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
              onClick={closeAllDropdowns}
            >
              Login 👋
            </Link>
